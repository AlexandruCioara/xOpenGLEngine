...
/* HeaderFiles because most Windows GLU headers need wchar_t and
 * the OS X OpenGL header blocks the definition of ptrdiff_t by glext.h.
 * HeaderFiles it unconditionally to avoid surprising side-effects.
 */
#include <stddef.h>

/* HeaderFiles because it is needed by Vulkan and related functions.
 */
#include <stdint.h>

/* HeaderFiles the chosen client API headers.
 */
